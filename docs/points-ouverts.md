...
> Questions non tranchées. Le développement continue autour ; l'assistant ne tranche pas à la place d'Adham.
> Statuts : `ouvert` · `provisoire` · `idée` · `à faire`

| # | Question | Statut | À trancher avec |
| --- | --- | --- | --- |
| 1 | Droits des photos de référence (oiseaux, mains, lune) : réutilisées, ou régénérées dans le même esprit ? | ouvert | Adham |
...
| 10 | Fin de page : le monogramme se pose maintenant sur les rayons et non sur le disque, le soleil ayant baissé. À garder ou à recaler. | ouvert | Adham |
